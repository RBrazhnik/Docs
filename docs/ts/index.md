...
- Подсистема «Документы» - проведение закупочной деятельности, списание
  и утилизация оргтехники;
...
- Для информационного вида обеспечения АС используется организация
  данных объектами справочник и документ, состав и структура зависит от
  наполняемых данных;
...
- Для организационного вида обеспечения АС определяется взаимодействием
  сотрудников с отделом «Информационные технологии»;
...
- Автоматизированная система должна обеспечивать выполнение поставленных
  задач;
...
- Обслуживание АС должно вестись на стороне администрирования сервера и
  со стороны клиентской программы;
...
- Все компоненты и технологии, используемые в АС, должны соответствовать
  требованиям патентного законодательства и не нарушать права третьих
  лиц;
